                            ...
                            history[key].map((item, index) => {
                              return (
                                ...
                                >
                                  ...
                                  />
                                  <ListItem.Content>
                                    <ListItem.Title style={{ color: 'white', fontWeight: 'bold', fontSize: 15, marginBottom: 5 }}>
                                      {item.weight} {item.unit} con {item.cn} cn
                                    </ListItem.Title>
                                    <ListItem.Subtitle style={{ color: 'white', lineHeight: 20 }}>
                                      {item.ingredients.length} ingredientes utilizados
                                    </ListItem.Subtitle>
                                  </ListItem.Content>
